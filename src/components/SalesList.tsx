  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-5 sm:p-6 rounded-3xl shadow-sm border border-slate-200/90 space-y-4">
        ...
        {/* Row 2: Payment Method Filter placed under Search Bar */}
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="w-full sm:w-80">
            <select
              value={filterType}
              onChange={(e) => setFilterType(e.target.value)}
              className="w-full bg-slate-50 border border-slate-200 text-slate-900 font-black text-sm rounded-2xl px-4 py-3 outline-none cursor-pointer focus:bg-white focus:border-indigo-600 transition-all shadow-2xs"
            >
