...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="hidden min-[900px]:flex flex-col w-60 shrink-0">
      <div className="sticky top-24 bg-white rounded-2xl p-3 border border-slate-200/90 shadow-sm space-y-2">
        {tabs.map((tab) => {
          const Icon = tab.icon;
