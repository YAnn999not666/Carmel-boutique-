...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100/90 text-slate-900 font-sans p-4 sm:p-6 lg:p-8 pb-28 min-[900px]:pb-12 antialiased selection:bg-indigo-100 selection:text-indigo-900">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* 2. Main Content Area + Sidebar for desktop */}
