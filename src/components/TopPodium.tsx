...
export const TopPodium: React.FC<TopPodiumProps> = ({ items }) => {
  ...
  const podiumSlots = [
    {
      ...
      elevationClass: 'translate-y-8 sm:translate-y-12 md:translate-y-16 lg:translate-y-20', // Left pillar height offset
      colOrder: 'order-1',
    ...
    },
    {
      ...
      elevationClass: 'translate-y-0 sm:translate-y-2 md:translate-y-3 lg:translate-y-4', // Center pillar elevated
      colOrder: 'order-2',
    ...
    },
    {
      ...
      elevationClass: 'translate-y-12 sm:translate-y-18 md:translate-y-24 lg:translate-y-28', // Right pillar lowest offset
      colOrder: 'order-3',
  ...
  return (
    <div ref={containerRef} className="w-full max-w-2xl sm:max-w-3xl mx-auto relative flex flex-col items-center select-none pt-4 pb-2">
      ...
      <div className="w-full -mt-14 sm:-mt-22 md:-mt-28 lg:-mt-36 relative flex justify-center overflow-visible">
