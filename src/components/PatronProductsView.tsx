      ...
      {activeTab === 'DORMANT' && (
        <div className="bg-white rounded-2xl border-2 border-slate-300 shadow-sm overflow-hidden">
          <div className="p-5 sm:p-6 bg-purple-50/80 border-b-2 border-purple-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="px-3.5 py-1.5 rounded-xl bg-white border border-purple-200 text-purple-900 text-xs sm:text-sm font-black font-mono shrink-0 self-start sm:self-auto">
              {dormantProducts.length} article{dormantProducts.length > 1 ? 's' : ''} inactif{dormantProducts.length > 1 ? 's' : ''}
            </div>
          </div>
